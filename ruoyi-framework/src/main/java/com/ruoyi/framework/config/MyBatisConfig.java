...
public class MyBatisConfig
{
    ...
    static String setTypeAliasesPackage(String typeAliasesPackage)
{
    ...
    try
    {
        ...
        {
            throw new RuntimeException("MyBatis类型别名包扫描错误, 未找到任何包");
        }
    }
    catch (IOException e)
    {
        log.error("扫描类型别名包时出现IO异常", e);
        throw new RuntimeException("扫描类型别名包时出现异常", e);
    }
