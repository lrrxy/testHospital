<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单ID" align="center" prop="recordId" />
      ...
      <el-table-column label="金额" align="center" prop="sum" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="金额" prop="sum">
          <el-input v-model="form.sum" placeholder="请输入金额" />
        </el-form-item>
        <el-form-item label="缴费日期" prop="paymentDate">
          <el-date-picker clearable
...
<script>
import { listRecord, getRecord, delRecord, addRecord, updateRecord } from "@/api/payment/record";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除缴费记录信息编号为"' + recordIds + '"的数据项？').then(function() {
